...
const [comment, setComment] = useState("");
    ...
    function fetchParticipants() {
      if(participantId && fullName && phoneNumber && comment === "null"){
        console.log("Alla fält är tomma, inget händer....")
      } else {
      let searchData = {
        id: participantId ? participantId : "null",
        fullName: fullName ? fullName : "null",
        telephoneNumber: phoneNumber ? phoneNumber : "null",
      ...
      axios.post('http://localhost:9090/api/v1/participants/searchusers', searchData)
      .then((response) => {
    ...
    return (
      ...
      <div className="search-participant-container">
            ...
            />
            <Button variant="outlined" size="medium" onClick={fetchParticipants}>Sök</Button>
      </div>
